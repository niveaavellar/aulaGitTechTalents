...
public class Banco {
	...
	String senhaGerente = "1234"; //super segura a senha, parabéns 
		...
		do {
			...
			case 1:
				...
				if (!conta.listaDeTransacoes.isEmpty()) {
					...
					System.out.println("Ainda não foi feita nenhuma transação nesta conta.");
				}
			...
			case 5:
				...
				if (conta.getSaldo() == 0) {
					...
					System.out.println("O saldo desta conta é " + conta.getSaldo() + " e, portanto, não pode ser encerrada. O saldo deve ser 0 para prosseguir com o encerramento.");
				}
